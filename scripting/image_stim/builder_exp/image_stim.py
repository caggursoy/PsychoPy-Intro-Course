...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\cagatay.guersoy\\Documents\\Repos\\PsychoPy-Intro-Course\\scripting\\image_stim\\builder_exp\\image_stim.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            # Get the keys pressed and clear the events first
            ...
            if key_resp_2.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_2.getKeys(keyList=['return','left','right','space'], ignoreKeys=["escape"], waitRelease=False)
